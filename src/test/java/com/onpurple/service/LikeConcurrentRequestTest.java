...
//        // User 객체 생성 및 저장
//        User author = TestUtil.createUser("작성자1", "author1");
...
//                            User user = TestUtil.createUser("좋아요1"+ finalI, "좋아요유저1"+ finalI);
...
//        assertEquals(threadCount, resultPost.getLikes(), "좋아요 수 일치");
...
//
//        // given
//        final Post savepost = postRepository.findById(1L).orElse(null);
//
//
//        int threadCount = 10;
//        ExecutorService executorService = Executors.newFixedThreadPool(threadCount);
...
//                        try {
//                            // 각 스레드별로 새로운 user 생성 및 저장
//                            User user = userRepository.findByUsername("좋아요1"+ finalI).orElse(null);
//                            user = userRepository.save(user);
//                            likeService.postLike(savepost.getId(), user);
//                        } finally {
//                            latch.countDown();
...
//        assertEquals(0, resultPost.getLikes());
